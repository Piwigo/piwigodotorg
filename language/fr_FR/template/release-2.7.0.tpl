...
<p>Piwigo 2.7.0 ajoute 2 nouvelles langues : le basque (Euskara) et le luxembourgeois (Lëtzebuergesch). Votre participation est la bienvenue sur <a href="https://piwigo.org/translate">la plateforme de traduction de Piwigo.org</a> pour de nouvelles langues, des améliorations et les nouveautés à traduire sur le noyau Piwigo mais aussi sur les plugins et les thèmes. Il y a un grand nombre de chaînes à traduire donc nous avons véritablement besoin de l'aide de la communauté Piwigo !</p>

<div class="back_overview"><a href="#overview">↑ retour au survol</a></div>

<h3>Fonctionnalités pour les développeurs</h3>

<p>Merci de noter qu'une documentation détaillée est disponible <a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7">Technical changes in Piwigo 2.7</a> (en anglais). Merci de la lire avec attention pour rendre vos extensions compatibles.</p>
...
<h4 id="selectize">Remplacement de TokenInput et Chosen par Selectize <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#selectize">détails</a>)</small></h4>
...
<h4 id="maintain">Maintenance des plugins et mise à jour automatique <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#plugin_maintenance_class">détails</a>)</small></h4>
...
<h4 id="triggers">Nouveaux noms pour les triggers <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#trigger_change_trigger_notify">détails</a>)</small></h4>
...
<h4 id="conf_update">Améliorations de conf_update_param() <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#conf_update_param">détails</a>)</small></h4>
...
<h4 id="event_path">Chemin d'inclusion pour add_event_handler <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#add_event_handler_4th_parameter">détails</a>)</small></h4>
...
<h4 id="colorscheme">colorscheme  <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#themeconf_colorscheme">détails</a>)</small></h4>
...
<h4 id="plugins_batch_manager">Plugins et gestion par lot <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#batch_manager_add_filters">détails</a>)</small></h4>
