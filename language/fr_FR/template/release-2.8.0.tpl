...
<p>Merci de noter qu'une documentation détaillée est disponible <a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.8">Technical changes in Piwigo 2.8</a> (en anglais). Merci de la lire avec attention pour rendre vos extensions compatibles.</p>

<h4 id="php7">PHP 7 <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.8#php_7">détails</a>)</small></h4>
...
<h4 id="logger">Logger <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.8#logger">détails</a>)</small></h4>
...
<h4 id="trigger_upload_file">Traitement du fichier ajouté <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.8#process_file_on_upload">détails</a>)</small></h4>
