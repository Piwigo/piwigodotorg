...
$lang['porg_guides_img_docker_update_pwg_step4_paragraph_1_v2'] = '使用命令 <code>docker compose pull</code> 拉取镜像，并使用命令 <code>docker compose up -d</code> 重启容器。';
$lang['porg_guides_img_docker_update_pwg_step4_paragraph_2_v2'] = '你可以使用命令 <code>docker logs</code> 并指定容器名称（以 <code>piwigo-main-1</code> 结尾）来查看日志。';