...
<p>如需了解更详细的文档，请点击 <a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.8"> Piwigo 2.8 技术革新 </a>进行查阅。请您仔细阅读该文档，以确保您的拓展插件可以与 Piwigo 2.8 兼容。</p>

<h4 id="php7">PHP 7 <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.8#php_7">详情</a>)</small></h4>
...
<h4 id="logger">Logger <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.8#logger">详情</a>)</small></h4>
<p>Piwigo 2.8 从PHP代码中引入了一系列统一的Log信息（核心或插件中）。像<code>$logger->debug('message')</code>一样简单轻便。</p>

<h4 id="trigger_upload_file">上传文件处理 <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.8#process_file_on_upload">详情</a>)</small></h4>
