...
$lang['porg_guides_requirements_minimal_third'] = 'PHP 8.2+。Piwigo 可以使用 PHP 7.4+ 运行，但这些已停用的版本不再维护，可能会使您的网站面临安全漏洞。请参阅<a href="https://www.php.net/supported-versions.php" target="_blank">官方 PHP 支持版本</a>。';
