...
<p>A versão 2.6.0 do Piwigo adicionou o idioma American English, que é um pouco diferente do idioma British English. 45 idiomas foram atualizados. O Piwigo 2.6 dá suporte à 56 idiomas. Sua participação é bem vinda na nossa <a href="https://piwigo.org/translate">plataforma de tradução</a>, para novos idiomas, melhorias e novas palavras para traduzir.</p>

<div class="back_overview"><a href="#overview">↑ Voltar ao menu principal</a></div>

<h3>Características Técnicas</h3>

<p>Observe que a documentação mais detalhada está disponível em <a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.6">Technical changes in Piwigo 2.6</a> (em inglês). Por favor, leia para tornar suas extensões compatíveis o Piwigo 2.6.</p>

<h4 id="smarty_3">Smarty 3 <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#smarty_3">detalhes</a>)</small></h4>
...
<h4 id="l10n">Fuinção de tradução <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#l10n_translate_sprintf">detalhes</a>)</small>
</h4>
...
<h5>Novos métodos <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#new_api_methods">detalhes</a>)</small></h5>
<ul>
...
<h5>Novas opções <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#new_options_for_api_methods">details</a>)</small>
</h5>
...
<h4 id="email">Sistema de e-mail <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#new_email_system">detalhes</a>)</small></h4>
...
<h4 id="gps">Metadados GPS <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#gps_metadata">detalhes</a>)</small>
</h4>
...
<h4 id="jquery">Bibliotecas Javascript atualizadas <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#jquery_19">detalhes</a>)</small>
</h4>
...
<h4 id="new_section">Melhor suporte para novas seções públicas <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#generic_template_for_custom_pages">detalhes</a>)</small>
</h4>
...
<h4 id="maintenance_class">New maintenance class <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:extensions:plugins#plugin_maintenance">details</a>)</small>
</h4>
...
<h4 id="trigger_name">Rename trigger functions <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#triggers_functions">details</a>)</small>
</h4>
...
<h4 id="template_cssjs">Templated CSS and JS files <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#css_js_as_smarty_templates">details</a>) </small>
</h4>
...
<h4 id="action_buttons">Improve template methods to sort action buttons <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#add_action_buttons">details</a>)</small>
</h4>
