...
<p>Piwigo 2.7.0 adiciona dois novos idiomas: basco (Euskara) e luxemburguês (Lëtzebuergesch). Sua participação é bem-vinda em <a href="https://piwigo.org/translate"> Plataforma de tradução Piwigo.org</a> tradução, por novas linguagens, melhorias e novas frases para traduzir no núcleo Piwigo, mas também em plugins e temas . Há muitas expressões a traduzir então nós realmente precisamos da ajuda da comunidade Piwigo!</p>

<div class="back_overview"><a href="#overview">↑ Voltar para Visão Geral</a></div>

<h3>Recursos Técnicos</h3>

<p>Por favor, note que a documentação mais detalhada está disponível em <a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7"> mudanças técnicas em Piwigo 2.7 </a>. Por favor, leia para fazer suas extensões compatíveis com Piwigo 2.7.</p>
...
<h4 id="selectize">Substituindo TokenInput & Selecionado por Escolha <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#selectize">detalhes</a>)</small></h4>
...
<h4 id="maintain">Plugins de manutenção & de atualização automática <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#plugin_maintenance_class">details</a>)</small></h4>
...
<h4 id="triggers">Funções de disparo renomear <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#trigger_change_trigger_notify">detalhes</a>)</small></h4>
...
<h4 id="conf_update">conf_update_param() melhorias <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#conf_update_param">detalhes</a>)</small></h4>
...
<h4 id="event_path">Dê incluir caminho para add_event_handler <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#add_event_handler_4th_parameter">detalhes</a>)</small></h4>
...
<h4 id="colorscheme">Tema colorscheme  <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#themeconf_colorscheme">detalhes</a>)</small></h4>
...
<h4 id="plugins_batch_manager">Plugins e Gerenciador de Lotes <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#batch_manager_add_filters">details</a>)</small></h4>
