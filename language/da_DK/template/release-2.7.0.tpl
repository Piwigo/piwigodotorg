...
<p>Piwigo 2.7.0 indeholder to nye sprog: Baskisk (euskara) og luxembourgsk (lëtzebuergesch). Din deltagelse er velkommen på <a href="https://piwigo.org/translate">Piwigo.org's oversættelsesplatform</a>, hvad angår nye sprog, forbedringer og nye strenge at oversætte i Piwigos kerne, men også i plugins og temaer. Der er mange strenge at oversætte, så vi har virkelig brug for hjælp fra Piwigo-fællesskabet!</p>

<div class="back_overview"><a href="#overview">↑ tilbage til oversigt</a></div>

<h3>Tekniske funktioner</h3>

<p>Bemærk at der findes mere detaljeret dokumentation om <a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7">tekniske ændringer i Piwigo 2.7</a>. Vær venlig at læse den, for at gøre dine udvidelser kompatible med Piwigo 2.7.</p>
...
<h4 id="selectize">TokenInput og Chosen erstattes af Selectize <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#selectize">mere info</a>)</small></h4>
...
<h4 id="maintain">Pluginvedligeholdelse og autoopdatering <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#plugin_maintenance_class">mere info</a>)</small></h4>
...
<h4 id="triggers">Omdøbning af triggerfunktioner <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#trigger_change_trigger_notify">mere info</a>)</small></h4>
...
<h4 id="conf_update">Forbedringer af conf_update_param() <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#conf_update_param">mere info</a>)</small></h4>
...
<h4 id="event_path">Overførsel af include-sti til add_event_handler <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#add_event_handler_4th_parameter">mere info</a>)</small></h4>
...
<h4 id="colorscheme">Temafarveudlægning <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#themeconf_colorscheme">mere info</a>)</small></h4>
...
<h4 id="plugins_batch_manager">Plugins og Batch Manager <small>(<a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.7#batch_manager_add_filters">mere info</a>)</small></h4>
