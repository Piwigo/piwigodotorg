...
$lang['porg_guides_requirements_minimal_third'] = 'PHP 8.2+. Piwigo can run with PHP 7.4+ but these end-of-life versions are no longer maintained and may expose your site to security vulnerabilities. See <a href="https://www.php.net/supported-versions.php" target="_blank">officially PHP supported versions</a>.';
