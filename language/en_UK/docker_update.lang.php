...
$lang['porg_guides_img_docker_update_step4'] = 'Step 4 - Updating and restarting the container';

$lang['porg_guides_img_docker_update_official_disclaimer_1'] = 'This guide only apply to the official Piwigo image, if you are using a Linux server container please use their documentation instead.';
...
// Step 1
$lang['porg_guides_img_docker_update_step1_paragraph_1'] = 'Containers\' version numbers will always match the Piwigo version, starting from 16.3.0 they will have an extra letter after to allow container specific updates';

// 16.3 and after
$lang['porg_guides_img_docker_update_pwg_higher_16_3'] = 'For container version 16.3 and higher';
$lang['porg_guides_img_docker_update_pwg_higher_16_3_paragraph'] = 'You should already be able to see if any update is available in the update interface, if you want to update to the minor version use the first number the tag has (eg: <code>16</code>)';

// Bellow 16.3
$lang['porg_guides_img_docker_update_pwg_lower_16_3'] = 'For container version 16.2 and lower';
