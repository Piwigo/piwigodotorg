...
$lang['porg_v12_plugin_manager_image1_label'] = 'The plugin manager already had a facelift in Piwigo 11, but it evolves again with v12.<br>
<br>
1) Until now, activated and deactivated plugins were displayed separately. Now they\'re all displayed together, unless you filter them.<br>
<br>
2) When you activated a new plugin, the screen reloaded, and you had to search in the list for the newly activated plugin, in order to access its settings. This was not very practical, especially for photo libraries with many plugins. With  Piwigo 12, a single click activates the plugin, and then you can directly modify its settings. It may seem a small improvement but that will change your life... well, maybe not your "whole" life but a least your life when you manage your plugins 😊';
