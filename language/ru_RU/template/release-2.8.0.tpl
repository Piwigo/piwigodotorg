...
<p>Внимание! Все подробности изложены в разделе <a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.8">Технические изменения в Piwigo 2.8</a>. Необходимо убедиться, что Ваши расширения соотвествуют требованиям Piwigo 2.8.</p>
...
<h4 id="trigger_upload_file">Процесс загрузки файла <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.8#process_file_on_upload">details</a>)</small></h4>
