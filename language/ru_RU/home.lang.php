...
$lang['porg_home_organisation_title'] = 'Тысячам организаций всех форм собственности и милллионам индивидуальных пользователей нравится Piwigo';
$lang['porg_home_sustainable_desc'] = 'Созданная в 2002 году, Piwigo поддерживается своими пользователями более %d лет. Постоянное развитие, только вперед!';
$lang['porg_home_title'] = 'Управляйте своим собранием изображений';
$lang['Discover Piwigo'] = 'Изучаем Piwigo';
$lang['Explore more features'] = 'Исследуйте больше особенностей';
$lang['Powerful features for your photo gallery'] = 'Мощные функции для Вашей галереи изображений';
$lang['Why choose Piwigo?'] = 'Почему выбирают Piwigo?';
$lang['porg_love_title'] = 'Они любят Piwigo';
$lang['porg_showcase_title'] = 'Прекрасные галереи, созданные с Piwigo';
$lang['version %s'] = 'версия %s';
$lang['page_meta_description'] = 'Управляйте своей библиотекой фотографий с Piwigo! Бесплатное программное обеспечение с открытым исходным кодом для организации и обмена фотографиями и цифровыми медиа в Интернете.';
