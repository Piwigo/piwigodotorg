...
<p>Piwigo 2.6.0 añade el idioma inglés americano, el cuál es ligeramente diferente del inglés británico. 45 idiomas han sido actualizados. Piwigo 2.6 soporta ya 56 idiomas. Vuestra participación es bienvenida en nuestra <a href="http://piwigo.org/translate">plataforma de traducción</a>, para nuevos idiomas, mejoras y nuevas cadenas de texto a traducir.</p>

<div class="back_overview"><a href="#overview">↑ subir a visión general</a></div>

<h3>Características técnicas</h3>

<p>Debe tenerse en consideración que hay disponible más documentación detallada sobre los <a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.6">cambios técnicos en Piwigo 2.6</a>. Considérese su lectura para hacer que vuestras extensiones sean compatibles con Piwigo 2.6.</p>

<h4 id="smarty_3">Smarty 3 <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#smarty_3">detalles</a>)</small></h4>
...
<h4 id="l10n">Función de traducción <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#l10n_translate_sprintf">detalles</a>)</small></h4>
...
<h5>Nuevos métodos <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#new_api_methods">detalles</a>)</small></h5>
<ul>
...
<h5>Nuevas opciones <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#new_options_for_api_methods">detalles</a>)</small></h5>
...
<h4 id="email">Sistema de correo <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#new_email_system">detalles</a>)</small></h4>
...
<h4 id="gps">Metadatos GPS <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#gps_metadata">detalles</a>)</small></h4>
...
<h4 id="jquery">Librerías Javascript actualizadas <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#jquery_19">detalles</a>)</small></h4>
...
<h4 id="new_section">Mejorado el soporte para nuevas secciones públicas <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#generic_template_for_custom_pages">detalles</a>)</small></h4>
...
<h4 id="maintenance_class">Nueva clase de mantenimiento <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:extensions:plugins#plugin_maintenance">detalles</a>)</small></h4>
...
<h4 id="trigger_name">Disparadores renombrados<small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#triggers_functions">detalles</a>)</small></h4>
...
<h4 id="template_cssjs">Plantillas para los archivos CSS y JS <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#css_js_as_smarty_templates">detalles</a>)</small></h4>
...
<h4 id="action_buttons">Se mejoran los métodos de la plantilla para los botones que accionan la ordenación <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#add_action_buttons">detalles</a>)</small></h4>

<p><a href="http://piwigo.org/releases/2.5.0#action_buttons">En la versión 2.5 se añadieron</a> dos métodos botones que accionaban la ordenación en la página de index así como en la página de la foto. Según lo planeado, su uso cambió un poco para la versión 2.6: las extensiones no deberán declarar sus botones alrededor de <code>&lt;span&gt;, &lt;div&gt; or &lt;li&gt;</code> ya que este marcado ahora se controla por la plantilla.</p>
