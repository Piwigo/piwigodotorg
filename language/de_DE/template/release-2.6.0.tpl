...
<h4 id="gps">GPS Metadaten <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#gps_metadata">details</a>)</small></h4>
...
<h4 id="jquery">Javascript Libraries aktualisiert <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.6#jquery_19">details</a>)</small></h4>
