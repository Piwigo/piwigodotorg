...
<p>Eine detaillierte Dokumentation ist unter <a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.8">Technische Änderungen in Piwigo 2.8</a> zu finden. Bitte lesen Sie diese Hinweise, um Ihre Erweiterungen mit Piwigo 2.8. kompatibel zu machen.</p>

<h4 id="php7">PHP 7 <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.8#php_7">Einzelheiten</a>)</small></h4>
...
<h4 id="logger">Logger <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.8#logger">Einzelheiten</a>)</small></h4>
...
<h4 id="trigger_upload_file">Bearbeiten von Dateien beim Upload <small>(<a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.8#process_file_on_upload">Einzelheiten</a>)</small></h4>
