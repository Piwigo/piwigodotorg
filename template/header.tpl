      ...
      <div class="collapse navbar-collapse align-items-center" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-right align-items-center">
          <li class="nav-btn-wrapper">
            ...
            <div class="mobile-sub-content d-lg-none">{include file='template/include/sub_menu/sub_menu_item_get_started.tpl'}</div>
          </li>
          <li class="nav-btn-wrapper">
            {include file='template/include/sub_menu/sub_menu_button.tpl' is_openable=true label={'Product'|translate}}
            <div class="mobile-sub-content d-lg-none">{include file='template/include/sub_menu/sub_menu_item_product.tpl'}</div>
          </li>
          <li class="nav-btn-wrapper">
          ...
          <li class="nav-btn-wrapper">
            ...
            <div class="mobile-sub-content d-lg-none">{include file='template/include/sub_menu/sub_menu_item_support.tpl'}</div>
          </li>
          <li class="nav-btn-wrapper">
            {include file='template/include/sub_menu/sub_menu_button.tpl' is_openable=true label={'Behind the code'|translate}}
            <div class="mobile-sub-content d-lg-none">{include file='template/include/sub_menu/sub_menu_item_behind_code.tpl'}</div>
          </li>
          <li class="nav-btn-wrapper">
            {include file='template/include/sub_menu/sub_menu_button.tpl' is_openable=true label={'News'|translate}}
            <div class="mobile-sub-content d-lg-none">{include file='template/include/sub_menu/sub_menu_item_news.tpl'}</div>
          </li>
        </ul>
