...
<section class="container-fluide container-fluide-manual-installation">
    ...
    <div class="container">
      <div class="row guide-steps">
        ...
        <div class="col-md-6 col-xs-12">
          <a href="#step3-manual-installation">{'porg_guides_installation_step3'|translate}</a>
          <a href="#step4-manual-installation">{'porg_guides_installation_step4'|translate}</a>
        </div>
      </div>
    </div>
  </section>
