  ...
  <section class="container-fluide container-fluide-piwigo-fundamental">
    <div class="container">
  ...
  <section class="container-fluide container-fluide-whatispiwigo-gnu-license">
    <div class="container">
      <div class="row">
        <div class="col-md-1 col-xs-2 gnu-logo">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="collapse whatispiwigo-gnu-collapse" id="gnuLicense">
            <div class="card card-body">
              <div class="col-md-3 col-xs-3 pwg-gnu-logo">
