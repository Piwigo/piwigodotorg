  <section class="container-fluide mobile_applications">
    <div class="container mobile_main_section">
      ...
      <div class="col-md-6 col-xs-12 text-center mobile_center_text_right" >
        <img src="{$PORG_ROOT_URL}images/mobile_applications/mobile-applications-banner.svg"/>
      </div>
    </div>
  </section>
    ...
    <div class="container mobile_first_section">
      <div class="row">
        <div class="col-md-6 col-xs-12 text-center mobile-applications-desktop-display">
          <video width="184" height="400" controls>
            <source src="{$PORG_ROOT_URL}images/mobile_applications/demo-piwigo-mobile.mp4" type="video/mp4">
          </video>
        </div>
    ...
    <div class="container ">
      <div class="row">
        ...
        <div class="col-md-4"col-xs-12 >
          <img src="{$PORG_ROOT_URL}images/mobile_applications/upload-photos-1.svg"/>
          <h3>{'mobile_applications_size_quality_title'|translate}</h3>
          <p>{'mobile_applications_size_quality_texte'|translate}</p>
        </div>
        <div class="col-md-4 col-xs-12 ">
          <img src="{$PORG_ROOT_URL}images/mobile_applications/upload-photos-2.svg"/>
          <h3>{'mobile_applications_metadata_title'|translate}</h3>
          <p>{'mobile_applications_metadata_texte'|translate}</p>
        </div>
        <div class="col-md-4 col-xs-12 ">
          <img src="{$PORG_ROOT_URL}images/mobile_applications/upload-photos-3.svg"/>
...
<img src="{$PORG_ROOT_URL}images/features/feature-elements-part-two-top-wave.svg">
    <section class="container-fluide mobile_applications">
      <div class="container-fluide mobile-fourth-section">
      <div class="container ">
        <div class="row ">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <h5 class="modal-title">{'mobile_applications_scan_qr'|translate}</h5>
        <img src="{$PORG_ROOT_URL}images/mobile_applications/ios_qr_code.png"/>
