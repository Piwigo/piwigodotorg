...
<p>Please note that more detailed documentation is available about <a href="https://piwigo.org/doc/doku.php?id=dev:changes_in_2.8">Technical changes in Piwigo 2.8</a>. Please read it to make your extensions compatible with Piwigo 2.8.</p>
