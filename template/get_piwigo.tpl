...
<img class="get-piwigo-intro-wave" src="{$PORG_ROOT_URL}images/get_piwigo/intro-top-wave.svg">
      ...
      <div class="col-md-6 col-xs-12 text-center">
        <div class="cloud-hosted-piwigo">
          ...
          <div class="btn-cloud-hosted-piwigo">
            <a class="btn" href="https://piwigo.com/pricing"><span class="bold">Start Free trial</span></a>
          </div>
  ...
  <section class="container-fluide">
    <div class="container">
      <div class="equal">
        <div class="piwigo-mobile-apps-container">
        ...
        <div class="col-md-6 col-xs-12 piwigo-phone">
          <img src="{$PORG_ROOT_URL}images/get_piwigo/mobile-mockup-get-piwigo.jpg">
        </div>
      </div>
