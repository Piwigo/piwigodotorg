...
<section class="container release-notes-intro">
  <div class="row">
<p>Version 2.6 introduces new features for users, especially administrators. The mobile theme now has important improvements. The user manager has been redesigned from scratch. The new plugin "Admin Tools" will let you edit albums and photos from the gallery. A new mail system presents clean graphical themes and a robust engine. Version 2.6 also introduces technical features including simpler coding for plugin creators.</p>
</div>
</section>
...
<section id="overview" class="container-fluid release-notes-overview">
  <div class="container">
    <div class="row equal user-features">
      ...
      <div class="col-md-4">
<ul>
<li><a href="#mobile_theme">Mobile theme improvements</a></li>
<li><a href="#user_manager">User manager new design</a></li>
<li><a href="#admin_tools">Admin Tools</a></li>
<li><a href="#mail_themes">New mail themes</a></li>
<li><a href="#stats_geo">Geolocate visitors</a></li>
<li><a href="#group_manager">Group manager new design</a></li>
</ul>
</div>

<div class="col-md-4">
<ul>
<li><a href="#admin_icons">New admin icons</a></li>
<li><a href="#tag_filter">Tag filter</a></li>
<li><a href="#recent">Recent photos and albums</a></li>
<li><a href="#number_tags">Number of tags and comments</a></li>
<li><a href="#comment_manager">Comment manager</a></li>
<li><a href="#permission_inheritance">Permission inheritance</a></li>
</ul>
</div>

<div class="col-md-4">
<ul>
<li><a href="#edit_album">Edit album improved</a></li>
<li><a href="#theme_config">Default themes configuration</a></li>
<li><a href="#tiff">TIFF support</a></li>
<li><a href="#language">56 languages</a></li>
</ul>
</div>
...
<h3 id="mobile_theme">Mobile theme improvements</h3>
...
<p>Piwigo 2.6.0 adds language American English, which is slightly different from British English. 45 languages have been updated. Piwigo 2.6 supports 56 languages. Your participation is welcomed on <a href="http://piwigo.org/translate">our translation platform</a>, for new languages, improvements and new strings to translate.</p>
