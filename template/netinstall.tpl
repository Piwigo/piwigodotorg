      ...
      <div class="row row-guides">
        <div class="intro-text-container-netinstall">
          <div class="col-xs-12 col-md-6 col-guides-text">
            <h1>{'porg_guides_netinstall'|translate}</h1>
          </div>
        </div>
  ...
  <section>
    <div class="container">
      <div class="row guide-steps">
        ...
        <div class="col-md-6 col-xs-12">
          <a href="#step3-netinstall">{'porg_guides_netinstall_step3'|translate}</a>
          <a href="#step4-netinstall">{'porg_guides_netinstall_step4'|translate}</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section>
    <div class="container netinstall-content">
        ...
        <div class="col-md-4 col-xs-12 col-guides-text">
          ...
          <p>{'porg_guides_netinstall_step2_paragraph1'|translate}</p>
            <ul>
              ...
              <li>{'porg_guides_netinstall_step2_list3'|translate}</li>
            </ul>
            <p>{'porg_guides_netinstall_step2_paragraph2'|translate}</p>
            <p>{'porg_guides_netinstall_step2_paragraph3'|translate}</p>
        </div>
        <div class="col-md-8 col-xs-12 guide-image-and-caption">
          <img src="{$PORG_ROOT_URL}images/guides/netinstall-image-1.png">
      ...
      <div class="row step3-content-netinstall">
        ...
        <div class="col-md-8 col-xs-12 guide-image-and-caption">
          <img src="{$PORG_ROOT_URL}images/guides/netinstall-image-2.png">
      ...
      <div class="row step3-content-netinstall">
        ...
        <div class="col-md-8 col-xs-12 guide-image-and-caption">
          <img src="{$PORG_ROOT_URL}images/guides/netinstall-image-3.png">
      ...
      <div class="row step3-content-netinstall">
        ...
        <div class="col-md-8 col-xs-12 guide-image-and-caption">
          <img src="{$PORG_ROOT_URL}images/guides/netinstall-image-4.png">
      ...
      <div class="row step3-content-netinstall guide-longer-text" >
        <div class="col-md-4 col-xs-12 col-guides-text">
          ...
          <ul>
            ...
            <li>{'porg_guides_netinstall_step3_list2'|translate}<span> ({'porg_guides_netinstall_step3_list2_span'|translate})</span></li>
            <li>{'porg_guides_netinstall_step3_list3'|translate}</li>
            <li>{'porg_guides_netinstall_step3_list4'|translate}</li>
            <li>{'porg_guides_netinstall_step3_list5'|translate}<span> ({'porg_guides_netinstall_step3_list5_span'|translate})</span>
          </ul>
          <p>{'porg_guides_netinstall_step3_paragraph6'|translate}:</p>
          <ul>
            <li>{'porg_guides_netinstall_step3_list6'|translate}</li>
            <li>{'porg_guides_netinstall_step3_list7'|translate}</li>
            <li>{'porg_guides_netinstall_step3_list8'|translate}</li>
          </ul>
          <p>{'porg_guides_netinstall_step3_paragraph7'|translate}</p>
          <p>{'porg_guides_netinstall_step3_paragraph8'|translate}</p>
        </div>
        <div class="col-md-8 col-xs-12 guide-image-and-caption">
          <img src="{$PORG_ROOT_URL}images/guides/netinstall-image-5.png">
          <p>{'porg_guides_netinstall_image_caption5'|translate}</p>
        </div>
      </div>
      <div class="row step4-content-netinstall">
        ...
        <div class="col-md-8 col-xs-12 guide-image-and-caption">
          <img src="{$PORG_ROOT_URL}images/guides/netinstall-image-5.png">
          <p>{'porg_guides_netinstall_image_caption6'|translate}</p>
        </div>
      </div>
