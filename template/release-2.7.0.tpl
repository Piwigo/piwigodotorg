...
<p>Piwigo 2.7.0 adds two new languages: Basque (Euskara) and Luxembourgish (Lëtzebuergesch). Your participation is welcomed on <a href="http://piwigo.org/translate">Piwigo.org translation platform</a>, for new languages, improvements and new strings to translate in Piwigo core but also in plugins and themes. There are many strings to translate so we really need help from Piwigo community!</p>

<div class="back_overview"><a href="#overview">↑ back to overview</a></div>

<h3>Technical features</h3>

<p>Please note that more detailed documentation is available about <a href="http://piwigo.org/doc/doku.php?id=dev:changes_in_2.7">Technical changes in Piwigo 2.7</a>. Please read it to make your extensions compatible with Piwigo 2.7.</p>
