...
<section id="overview" class="container-fluid release-notes-overview">
  <div class="container">
    <div class="row equal user-features">
      ...
      <div class="col-md-4">
<ul>
<li><a href="#user_comments">User comments: Email and Website added</a></li>
<li><a href="#tag_duplication">Tag duplication</a></li>
<li><a href="#pagination_album">Pagination on albums</a></li>
<li><a href="#filter_dimensions">Batch manager: filter on dimensions</a></li>
...
<div class="col-md-4">
<ul>
<li><a href="#icons">Better looking icons</a></li>
<li><a href="#oauth">Connect with Facebook, Google, OpenID...</a></li>
<li><a href="#loading_image">Temporary image while loading</a></li>
<li><a href="#languages">51 languages</a></li>
<li><a href="#physical_albums">Physical vs virtual albums</a></li>
</ul>
</div>

<div class="col-md-4">
<ul>
<li><a href="#protection">Protection of original photos</a></li>
<li><a href="#tag_exclusion">Tag exclusion in quick search</a></li>
<li><a href="#ip_session">IP address and sessions</a></li>
</ul>
</div>
...
<ul>
<li><a href="#api_explorer">New web API explorer</a></li>
<li><a href="#passwords">increased security on passwords</a></li>
<li><a href="#mysqli">mysqli library for MySQL</a></li>
<li><a href="#javascriptpacker">JSmin replaced by JavaScriptPacker</a></li>
</ul>
</div>

<div class="col-md-4">
<ul>
<li><a href="#flags_sprite">Sprite for flags</a></li>
<li><a href="#session_messages">Sessions can store infos, errors and warnings</a></li>
<li><a href="#triggers">Add triggers on all main pages</a></li>
<li><a href="#action_buttons">Add template method to sort action buttons</a></li>
</ul>
</div>
...
<li><a href="#mobile_detection">Earlier detection of mobile device</a></li>
<li><a href="#login_triggers">Triggers for login system</a></li>
</ul>
</div>
</div>
</div>
...
<h4 id="login_triggers">Triggers for login system</h4>

<p>We have added 3 triggers: user_login, user_logout, try_log_user. It makes plugins for external authentication easier to create (such as oAuth).</p>
